...
| LC-SDA                | 光（长链）         | 待补充（无文献报道）                   | 无公开应用文献（NHS-diazirine 长链类似物，制造商称膜可渗透；见[Sigma-Aldrich 产品页](https://www.sigmaaldrich.cn/CN/zh/product/aldrich/803421) / [Thermo 产品页](https://www.thermofisher.com/order/catalog/product/26168)）                                                                                                                                                                                                                                                                 |
...
> 2. LC-SDA（succinimidyl 6-(4,4′-azipentanamido)hexanoate）为 SDA 的长链（10–30 Å）类似物，
>    其膜可渗透性为制造商声明；PNAS 2017（Walker-Gray et al.）使用的是 **SDA**（短链 3.9 Å），不是 LC-SDA。
